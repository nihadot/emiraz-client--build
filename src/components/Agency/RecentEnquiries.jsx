...
import { getEnquiries, getEnquiriesByAgency, updateEnquiryStatus, updateEnquiryStatusAgencyAPI, updateToggleLock, updateToggleLockAgency } from '../../api';
...
function RecentEnquiries({ searchTerm, selectedFilter,selectedFilterDeveloper,selectedFilterAgency }) {
  ...
  return (
    <div className=' md:h-[85vh] w-full  mt-5 mx-0'>
      <div className='grid bg-gray-200 rounded-lg py-3 w-full text-base sf-medium-600 grid-cols-6 justify-items-center gap-4'>
      ...
      <div className='mt-1 w-full'>
        {filteredProperties && filteredProperties.length > 0 &&
          filteredProperties.map((item, index) => {
            return (
              <div className=' grid bg-gray-200 rounded-lg mt-1 w-full py-3 items-center poppins-medium text-[12px] grid-cols-6 justify-items-center gap-0 '>
