...
const PaymentsForm = ({ name, value, onChange, reset }) => {
  ...
  // Reset the payment options when reset prop changes
  useEffect(() => {
    if (reset) {
      setPaymentOptions([""]); // Reset to a single empty field or initial state
