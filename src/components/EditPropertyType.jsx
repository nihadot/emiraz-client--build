...
import { MAIN_IMAG_URL, updatePropertyType } from "../api";
...
function EditPropertyType() {
  ...
  const handleSubmit = async (e) => {
    try {
      ...
      await updatePropertyType(formDataFields);
      successToast("Successfully Updated");
      navigate("/admin/view-property-type");
      setIsLoading(false);
    } catch (error) {
      errorToast(
    ...
    <form onSubmit={handleSubmit} className="flex flex-wrap">
      <div className="flex-1">
        ...
        <div className="flex flex-col gap-2 mx-3">
          <label
            htmlFor="name"
            className="sf-medium font-medium text-sm text-[#000000] capitalize"
          >
            Property Type Name
          </label>
          <input
        ...
        {/* <div className="flex flex-col gap-2 mx-3 m-3">
          ...
          <input
            ...
            type="text"
            id="description"
            placeholder="New Projects Available"
