...
import { assignedToAgencyAPI, getAgency, getEnquiries, updateEnquiryStatus, updateNoteForAdminEnquiry, updateToggleLock } from '../api';
...
function DuplicateEnquiries({ toggleButton,searchTerm, selectedFilter,selectedFilterDeveloper,selectedFilterAgency }) {
...
export default DuplicateEnquiries
