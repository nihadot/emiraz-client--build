...
import { MAIN_IMAG_URL, deleteBannerLogo, getBannerLogos } from "../api";
  ...
  return (
    <div>
      <div className="">
        ...
        {
          <div className="flex gap-3 flex-wrap bg-black rounded-xl min-h-[80vh] justify-center items-center">
            {data.map((item) => {
              return (
                <div className="" key={item._id}>
                  ...
                  <a
                    ...
                    className=" text-green-500 me-4 cursor-pointer text-xs  hover:underline font-medium"
                  >
                    Edit
                  </a>
                  <a
                    ...
                    className="text-red-600 cursor-pointer text-xs  hover:underline font-medium"
                  >
                    Delete
                  </a>
                </div>
