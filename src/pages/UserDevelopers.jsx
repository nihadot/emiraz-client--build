...
function UserDevelopers() {
  ...
  const { name:nameOfPropertyType,id:idOfPropertyType } = useParams();
    ...
    <>
        ...
        <>
          <div>
            ...
            <h1 className="px-5 md:px-20 lg:px-28 text-center mt-4 sf-medium-600 text-[35px] uppercase sm:text-[70px]">
              {nameOfPropertyType}
            </h1>
            <section className="max-w-[1400px] w-full m-auto">
              <div className="px-5  flex flex-col justify-center my-4 lg:my-14 items-center md:px-20 lg:px-28  ">
